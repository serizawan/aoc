...
if __name__ == "__main__":
    ...
    min_shortest_path = math.inf
    for i in range(h):
        for j in range(w):
            if lines[i][j] == "a":
                c_shortest_path = compute_dijkstra_shortest_paths(nodes, (i, j))[end_node]
                if c_shortest_path < min_shortest_path:
                    min_shortest_path = c_shortest_path
